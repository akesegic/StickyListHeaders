...
public class StickyListHeadersListView extends FrameLayout {
	...
	public StickyListHeadersListView(Context context, AttributeSet attrs,
		...
		mList.setHorizontalFadingEdgeEnabled(attrsList
				.isHorizontalFadingEdgeEnabled());
		mList.setVerticalFadingEdgeEnabled(attrsList
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
			...
			mList.setFastScrollAlwaysVisible(attrsList
					.isFastScrollAlwaysVisible());
		}
		mList.setScrollBarStyle(attrsList.getScrollBarStyle());
		mList.setVerticalScrollBarEnabled(attrsList
				.isVerticalScrollBarEnabled());
		mList.setHorizontalScrollBarEnabled(attrsList
